## Update site url
UPDATE `wp_options` SET `option_value` = 'http://wordpress.bubstimber.orb.dev' WHERE `option_name` = 'siteurl';
UPDATE `wp_options` SET `option_value` = 'http://wordpress.bubstimber.orb.dev' WHERE `option_name` = 'home';
